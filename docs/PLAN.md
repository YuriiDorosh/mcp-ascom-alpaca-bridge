...
### Deliverables
- **MVP operator UI** (`frontend/`, Vite + React): status/capabilities readouts and command actions against existing REST endpoints; documented in `frontend/README.md`; backend CORS for local dev (`CORS_ALLOWED_ORIGINS`).
